...
/* ~~~~~~~~~ DATA MEDIA ~~~~~~~~~ */
const Vnyori = JSON.parse(fs.readFileSync('./src/media/vn.json'))
const Stickeryori = JSON.parse(fs.readFileSync('./src/media/sticker.json'))
const Imageyori = JSON.parse(fs.readFileSync('./src/media/image.json'))
const Videoyori = JSON.parse(fs.readFileSync('./src/media/video.json'))
/* ~~~~~~~~~ WAKTU SETEMPAT ~~~~~~~~~ */
...
/* ~~~~~~~~~ STARTING & MODULE ALL ~~~~~~~~~ */
module.exports = yori = async (yori, m, msg, chatUpdate, store) => {
    try {
        /* ~~~~~~~~~ BASE yoriDEV ~~~~~~~~~ */
        const {
            type,
        ...
        const groupMetadata = m.isGroup ? await yori.groupMetadata(m.chat).catch(e => {}) : ''
...
let { key } = await yori.sendMessage(m.chat, {text: 'ʟᴏᴀᴅɪɴɢ...'})//Pengalih isu

for (let i = 0; i < aurelmayori.length; i++) {
/*await delay(10)*/
await yori.sendMessage(m.chat, {text: aurelmayori[i], edit: key });//PESAN LEPAS
}
}
        /* ~~~~~~~~~ REPLY ~~~~~~~~~ */
        async function newReply(teks) {
            ...
            return yori.sendMessage(m.chat, po, {
                quoted: m
            });
        };
        /* ~~~~~~~~~ ALL SYSTEM BOT ~~~~~~~~~ */
        ...
        if (autobio) {
            yori.updateProfileStatus(`-`).catch(_ => _)
        }
        ...
        if (isCommand) {
            ...
            yori.sendPresenceUpdate(yte, from)
        }
        if (m.sender.startsWith('212') && global.autoblok212 === true) {
            return yori.updateBlockStatus(m.sender, 'block')
        }
        ...
        for (let i of owner) {
            list.push({
                displayName: yori.getName(i + '@s.whatsapp.net'),
                vcard: `BEGIN:VCARD\n
VERSION:3.0\n
N:${yori.getName(i + '@s.whatsapp.net')}\n
FN:${yori.getName(i + '@s.whatsapp.net')}\n
item1.TEL;waid=${i}:${i}\n
item1.X-ABLabel:Ponsel\n
item2.EMAIL;type=INTERNET:creator@yori.my.id\n
item2.X-ABLabel:Email\n
item3.URL:https://profile.yoridev.xyz\n
...
END:VCARD`
        ...
        for (let Mwuhehe of Stickeryori) {
            if (budy === Mwuhehe) {
        ...
        if (akinator.hasOwnProperty(m.sender.split('@')[0]) && isCmd && ["0", "1", "2", "3", "4", "5"].includes(body)) {
            ...
            yori.sendText(m.chat, ini_txt, m).then(() => {
        ...
        if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await yori.sendText(m.chat, `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakgambar[m.sender.split('@')[0]]
        ...
        if (tebakasahotak.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await yori.sendText(m.chat, `🎮 Asah Otak 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakasahotak[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebaksiapakahaku.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await yori.sendText(m.chat, `🎮 Siapakah Aku 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaksiapakahaku[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebaksusunkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await yori.sendText(m.chat, `🎮 Susun Kata 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaksusunkata[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        ...
        if (tebakbendera2.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await yori.sendText(m.chat, `🎮 Tebak Bendera 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakbendera2[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebakkabupaten.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await yori.sendText(m.chat, `🎮 Tebak Kabupaten 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakkabupaten[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebakkimia.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await yori.sendText(m.chat, `🎮 Tebak Kimia 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakkimia[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebaktekateki.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await yori.sendText(m.chat, `🎮 Teka Teki 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaktekateki[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await yori.sendText(m.chat, `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaklagu[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await yori.sendText(m.chat, `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakkata[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await yori.sendText(m.chat, `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakkalimat[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebaklirik.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await yori.sendText(m.chat, `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaklirik[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await yori.sendText(m.chat, `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaktebakan[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`
            ...
            if (room.x !== room.o) yori.sendText(room.x, str, m, {
                mentions: parseMention(str)
            })
            yori.sendText(room.o, str, m, {
                mentions: parseMention(str)
            })
            if (isTie || isWin) {
        ...
        if (m.isGroup && !m.key.fromMe) {
            ...
            if (afk.checkAfkUser(m.sender, _afk)) {
                ...
                yori.sendTextWithMentions(m.chat, `@${m.sender.split('@')[0]} telah kembali dari afk`, m)
            }
        }
        switch (isCommand) {
            case 'autosimi':
            ...
            case 'siq': {
                ...
                let delb = await yori.downloadAndSaveMediaMessage(quoted)
            ...
            case 'join':
                try {
                    ...
                    await yori.groupAcceptInvite(result).then((res) => newReply(json(res))).catch((err) => newReply(json(err)))
                } catch {
            ...
            case 'setppbot':
                ...
                if (args[0] == 'full') {
                    ...
                    var memeg = await yori.updateProfilePicture(botNumber, {
                        url: medis
                    })
                    fs.unlinkSync(medis)
                    newReply(mess.done)
            ...
            case 'block':
                ...
                await yori.updateBlockStatus(blockw, 'block').then((res) => newReply(json(res))).catch((err) => newReply(json(err)))
                break
            case 'unblock':
                if (!isCreator) return newReply(mess.owner)
                let blockww = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '') + '@s.whatsapp.net'
                await yori.updateBlockStatus(blockww, 'unblock').then((res) => newReply(json(res))).catch((err) => newReply(json(err)))
                break
            case 'leave':
                if (!isCreator) return newReply(mess.owner)
                if (!m.isGroup) return newReply(mess.group)
                newReply('Dadah Semuanya 🥺')
                await yori.groupLeave(m.chat)
                break
            case 'backup':
                if (!isCreator) return newReply(mess.owner)
            ...
            case 'ambilcase':
                if (!isCreator) return newReply(mess.owner)
                const getCase = (cases) => {
                    return "case" + `'${cases}'` + fs.readFileSync("yori.js").toString().split('case \'' + cases + '\'')[1].split("break")[0] + "break"
                }
                newReply(`${getCase(q)}`)
                break
            ...
            case 'closetime':
                ...
                setTimeout(() => {
                    ...
                    yori.groupSettingUpdate(m.chat, 'announcement')
                    newReply(close)
                }, timer)
                break
            case 'opentime':
                ...
                setTimeout(() => {
                    ...
                    yori.groupSettingUpdate(m.chat, 'not_announcement')
                    newReply(open)
                }, timer)
                break
            case 'kick':
                ...
                await yori.groupParticipantsUpdate(m.chat, [blockwww], 'remove').then((res) => newReply(json(res))).catch((err) => newReply(json(err)))
                break
            case 'add':
                if (!m.isGroup) return newReply(mess.group)
                if (!isAdmins && !isGroupOwner && !isCreator) return newReply(mess.admin)
                ...
                await yori.groupParticipantsUpdate(m.chat, [blockwwww], 'add').then((res) => newReply(json(res))).catch((err) => newReply(json(err)))
                break
            case 'promote':
                if (!m.isGroup) return newReply(mess.group)
                if (!isAdmins && !isGroupOwner && !isCreator) return newReply(mess.admin)
                ...
                await yori.groupParticipantsUpdate(m.chat, [blockwwwww], 'promote').then((res) => newReply(json(res))).catch((err) => newReply(json(err)))
                break
            case 'demote':
                if (!m.isGroup) return newReply(mess.group)
                if (!isAdmins && !isGroupOwner && !isCreator) return newReply(mess.admin)
                ...
                await yori.groupParticipantsUpdate(m.chat, [blockwwwwwa], 'demote').then((res) => newReply(json(res))).catch((err) => newReply(json(err)))
                break
            case 'setname':
            case 'setsubject':
                if (!m.isGroup) return newReply(mess.group)
                ...
                if (!isBotAdmins) return newReply(mess.botAdmin)
                if (!text) return 'Text ?'
                await yori.groupUpdateSubject(m.chat, text).then((res) => newReply(mess.success)).catch((err) => newReply(json(err)))
                break
            case 'setdesc':
            case 'setdesk':
                if (!m.isGroup) return newReply(mess.group)
                ...
                if (!isBotAdmins) return newReply(mess.botAdmin)
                if (!text) return 'Text ?'
                await yori.groupUpdateDescription(m.chat, text).then((res) => newReply(mess.success)).catch((err) => newReply(json(err)))
                break
            case 'setppgroup':
            case 'setppgrup':
            case 'setppgc':
                ...
                if (args[0] == 'full') {
                    ...
                    var memeg = await yori.updateProfilePicture(m.chat, {
                        url: medis
                    })
                    fs.unlinkSync(medis)
                    newReply(mess.done)
            ...
            case 'grup':
                ...
                if (!isBotAdmins) return newReply(mess.botAdmin)
                if (args[0] === 'close') {
                    await yori.groupSettingUpdate(m.chat, 'announcement').then((res) => newReply(`Sukses Menutup Group 🕊️`)).catch((err) => newReply(json(err)))
                } else if (args[0] === 'open') {
                    await yori.groupSettingUpdate(m.chat, 'not_announcement').then((res) => newReply(`Sukses Membuka Group 🕊️`)).catch((err) => newReply(json(err)))
                } else {
            ...
            case 'editinfo':
                ...
                if (!isBotAdmins) return newReply(mess.botAdmin)
                if (args[0] === 'open') {
                    await yori.groupSettingUpdate(m.chat, 'unlocked').then((res) => newReply(`Sukses Membuka Edit Info Group 🕊️`)).catch((err) => newReply(json(err)))
                } else if (args[0] === 'close') {
                    await yori.groupSettingUpdate(m.chat, 'locked').then((res) => newReply(`Sukses Menutup Edit Info Group 🕊️`)).catch((err) => newReply(json(err)))
                } else {
            ...
            case 'resetlink':
                ...
                if (!isAdmins && !isGroupOwner && !isCreator) return newReply(mess.admin)
                if (!isBotAdmins) return newReply(mess.botAdmin)
                await yori.groupRevokeInvite(m.chat)
                    .then(res => {
            ...
            case 'liston':
                ...
                yori.sendText(m.chat, '⏰ List Online:\n\n' + online.map(v => '🌱 @' + v.replace(/@.+/, '')).join`\n`, m, {
                    mentions: online
                })
                break
...
`.trim()
            ...
            case 'speedtest': {
                ...
                try {
                    ...
                    if (stdout.trim()) yori.sendMessage(m.chat, {
                        text: stdout,
                        contextInfo: {
                            externalAdReply: {
                                showAdAttribution: true,
                    ...
                    if (stderr.trim()) yori.sendMessage(m.chat, {
                        text: stderr,
                        contextInfo: {
                            externalAdReply: {
                                showAdAttribution: true,
                ...
                yori.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: 'Script Free',
                            body: `SCRIPT BOT ${namabot} Ada Di Youtube @yoridev`,
            ...
            case 's': {
                ...
                if (/image/.test(mime)) {
                    ...
                    let encmedia = await yori.sendImageAsSticker(m.chat, media, m, {
                        packname: packname,
                        author: author
                    })
                    ...
                    let media = await quoted.download()
                    let encmedia = await yori.sendVideoAsSticker(m.chat, media, m, {
                        packname: packname,
                        author: author
                    })
                    await fs.unlinkSync(encmedia)
            ...
            case 'smeme': {
                ...
                let dwnld = await yori.downloadAndSaveMediaMessage(qmsg)
                let fatGans = await TelegraPh(dwnld)
                let smeme = `https://api.memegen.link/images/custom/${encodeURIComponent(bawah)}/${encodeURIComponent(atas)}.png?background=${fatGans}`
                let pop = await yori.sendImageAsSticker(m.chat, smeme, m, {
                    packname: packname,
                    author: author
                })
                fs.unlinkSync(pop)
            ...
            case 'swm': {
                ...
                newReply(mess.wait)
                if (/image/.test(mime)) {
                    let media = await yori.downloadMediaMessage(qmsg)
                    let encmedia = await yori.sendImageAsSticker(m.chat, media, m, {
                        packname: teks1,
                        author: teks2
                    })
            ...
            case 'toimg': {
                ...
                newReply(mess.wait)
                let media = await yori.downloadAndSaveMediaMessage(qmsg)
            ...
            case 'emojimix2': {
                ...
                for (let res of anu.results) {
                    let encmedia = await yori.sendImageAsSticker(m.chat, res.url, m, {
                        packname: global.packname,
                        author: global.author,
                        categories: res.tags
                    })
            ...
            case 'toviewonce': {
                ...
                if (/image/.test(mime)) {
                    anuan = await yori.downloadAndSaveMediaMessage(quoted)
                    yori.sendMessage(m.chat, {
                        image: {
                            url: anuan
                        },
                    ...
                    anuanuan = await yori.downloadAndSaveMediaMessage(quoted)
                    yori.sendMessage(m.chat, {
                        video: {
                            url: anuanuan
                        },
            ...
            case 'liststicker': {
                ...
                for (let x of Stickeryori) {
                    teks += `│⭔ ${x}\n`
                }
                teks += `│\n└────────────⭓\n\n*Total : ${Stickeryori.length}*`
                newReply(teks)
            }
            break
            case 'listimage': {
                let teks = '┌──⭓「 *List Image* 」\n│\n'
                for (let x of Imageyori) {
                    teks += `│⭔ ${x}\n`
                }
                teks += `│\n└────────────⭓\n\n*Total : ${Imageyori.length}*`
                newReply(teks)
            }
            break
            case 'listvideo': {
                let teks = '┌──⭓「 *List Video* 」\n│\n'
                for (let x of Videoyori) {
                    teks += `│⭔ ${x}\n`
                }
                teks += `│\n└────────────⭓\n\n*Total : ${Videoyori.length}*`
                newReply(teks)
            }
            break
            case 'addvideo': {
                ...
                if (Videoyori.includes(q)) return newReply("Nama Yang Kamu Masukan Sudah Ada")
                let delb = await yori.downloadAndSaveMediaMessage(quoted)
                Videoyori.push(q)
                await fsx.copy(delb, `./media/video/${q}.mp4`)
                fs.writeFileSync('./src/media/video.json', JSON.stringify(Videoyori))
                fs.unlinkSync(delb)
            ...
            case 'delvideo': {
                ...
                if (!Videoyori.includes(q)) return newReply("Nama Tidak Ada Di Dalam Database")
                let wanu = Videoyori.indexOf(q)
                Videoyori.splice(wanu, 1)
                fs.writeFileSync('./src/media/video.json', JSON.stringify(Videoyori))
            ...
            case 'addimage': {
                ...
                if (Imageyori.includes(q)) return newReply("Nama Yang Kamu Masukan Sudah Terdaftar Di Dalam Database")
                let delb = await yori.downloadAndSaveMediaMessage(quoted)
                Imageyori.push(q)
                await fsx.copy(delb, `./media/image/${q}.jpg`)
                fs.writeFileSync('./src/media/image.json', JSON.stringify(Imageyori))
                fs.unlinkSync(delb)
            ...
            case 'delimage': {
                ...
                if (!Imageyori.includes(q)) return newReply("Nama Image Yang Kamu Masukan Tidak Terdaftar")
                let wanu = Imageyori.indexOf(q)
                Imageyori.splice(wanu, 1)
                fs.writeFileSync('./src/media/image.json', JSON.stringify(Imageyori))
            ...
            case 'addsticker': {
                ...
                if (Stickeryori.includes(q)) return newReply("Nama Telah Di Pakai")
                let delb = await yori.downloadAndSaveMediaMessage(quoted)
                Stickeryori.push(q)
                await fsx.copy(delb, `./media/sticker/${q}.webp`)
                fs.writeFileSync('./src/media/sticker.json', JSON.stringify(Stickeryori))
                fs.unlinkSync(delb)
            ...
            case 'delsticker': {
                if (!isPremium) return newReply(mess.prem)
                if (args.length < 1) return newReply('Masukan Nama Stickernya')
                if (!Stickeryori.includes(q)) return newReply("Nama Tidak Terdaftar Di Database")
                let wanu = Stickeryori.indexOf(q)
                Stickeryori.splice(wanu, 1)
                fs.writeFileSync('./src/media/sticker.json', JSON.stringify(Stickeryori))
            ...
            case 'addvn': {
                ...
                if (Vnyori.includes(q)) return newReply("Nama Telah Di Pakai")
                let delb = await yori.downloadAndSaveMediaMessage(quoted)
                Vnyori.push(q)
                await fsx.copy(delb, `./media/audio/${q}.mp3`)
                fs.writeFileSync('./src/media/vn.json', JSON.stringify(Vnyori))
                fs.unlinkSync(delb)
            ...
            case 'delvn': {
                if (!isPremium) return newReply(mess.prem)
                if (args.length < 1) return newReply('Masukan Namanya')
                if (!Vnyori.includes(q)) return newReply("Nama Tidak Terdaftar Di Database")
                let wanu = Vnyori.indexOf(q)
                Vnyori.splice(wanu, 1)
                fs.writeFileSync('./src/media/vn.json', JSON.stringify(Vnyori))
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`
                    if (room.x !== room.o) await yori.sendText(room.x, str, m, {
                        mentions: parseMention(str)
                    })
                    await yori.sendText(room.o, str, m, {
                        mentions: parseMention(str)
                    })
                } else {
                    room = {
            ...
            case 'delttt': {
                ...
                try {
                    if (this.game) {
                        delete this.game
                        yori.sendText(m.chat, `Berhasil delete session TicTacToe`, m)
                    } else if (!this.game) {
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
                this.suit[id] = {
                    ...
                    status: 'wait',
                    waktu: setTimeout(() => {
                        if (this.suit[id]) yori.sendText(m.chat, `_Waktu suit habis_`, m)
                        delete this.suit[id]
                    }, 60000),
                    poin,
                    poin_lose,
            ...
            case 'math': {
                ...
                yori.sendText(m.chat, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
            ...
            case 'tebak': {
                if (args[0] === 'gambar') {
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    yori.sendText(m.chat, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    yori.sendText(m.chat, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    yori.sendText(m.chat, `Jawablah Pertanyaan Berikut : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    yori.sendImage(m.chat, result.url, `Silahkan Jawab Gambar Berikut\n\nWaktu : 60s`, m).then(() => {
            ...
            case 'akinatorstart':
                ...
                yori.sendText(m.chat, imi_txt, m).then(() => {
            ...
            */
            ...
            case 'ytmp4': {
                ...
                await yori.sendMessage(m.chat, {
                    ...
                    mimetype: 'video/mp4',
                    fileName: "Downloader Ytmp4 By yoriDev.mp4",
                    caption: ytmp4p,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
            ...
            case 'ytmp3': {
                ...
                await yori.sendMessage(m.chat, {
                    ...
                    mimetype: 'audio/mp3',
                    fileName: "Downloader Ytmp3 By yoriDev.mp3",
                    caption: ytmp4p,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
            ...
            case 'qc': {
                ...
                let ppnyauser = await await yori.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/6880771a42bad09dd6087.jpg')
                const rest = await quote(q, pushname, ppnyauser)
                newReply(mess.wait)
                yori.sendImageAsSticker(m.chat, rest.result, m, {
                    packname: `${global.packname}`,
                    author: `${global.author}`
                })
            }
            ...
            case 'telestick': {
                ...
                for (var ki = 0; ki < agg.result.sticker.length; ki++) {
                    await yori.sendImageAsSticker(m.chat, agg.result.sticker[ki], m, {
                        packname: packname,
                        author: author
                    })
                }
            ...
            case 'help':
                await loading()
                let mono = '```'
                let menunya = `${mono}Hello ${pushname}\nI Am ${namabot} Si Gadis Kawai Yang Akan Tumbuh Dewasa. Hallo Nama Ku Yori Terimakasih.
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
「 *BOT INFO* 」
┏━━━⬣*RUNTIME*━━━━━━━⊜
...
${prefix}remini${mono}`
        ...
        yori.sendText(numberowner + '@s.whatsapp.net', util.format(err), m)
